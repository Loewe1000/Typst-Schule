...
#let make-pill(key, value, colors, shape: none) = {
  ...
  // Bedingungsfelder (für Operatoren: und, oder, nicht)
  ...
  if key in dropdown-keys and type(value) == str {
    ...
    // Leere Bedingung → dunkler Platzhalter mit nested: true für kleinere Insets
    bedingung(colorschema: colors, type: "bedingung", [], nested: true)
  } else {
...
#let fill-template(template, args, colors, shape: none) = {
  ...
  // Baue Stack aus allen Parts mit angepasstem Spacing für Reporter
