...
#show-example(
  rendered: {
    import "/klassenarbeit/0.3.0/src/klassenarbeit.typ": aufgabe, erwartung, show-erwartungen
...
#show-example(
  rendered: {
    import "/klassenarbeit/0.3.0/src/klassenarbeit.typ": aufgabe, teilaufgabe, erwartung, show-erwartungen
