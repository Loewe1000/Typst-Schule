...
#let with-web(
  ...
  // Navigationsleiste oben rechts: „Übersicht"-Button (zurück zur
  // Paketübersicht/Startseite, immer sichtbar) plus Versions-Dropdown, das
  // zur Laufzeit {paket}/versions.json (von build.sh erzeugt) lädt und nur
  // bei mindestens zwei dokumentierten Versionen erscheint.
